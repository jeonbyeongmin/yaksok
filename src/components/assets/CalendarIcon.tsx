  ...
  return (
    <svg
      ...
      <Path
        ...
        color={color}
      />
      <Path d="M17.2109 24.9556H20.7374V28.482H17.2109V24.9556Z" color={color} />
      <Path d="M28.2363 24.9556H31.7628V28.482H28.2363V24.9556Z" color={color} />
      <Path d="M39.2627 24.9556H42.7892V28.482H39.2627V24.9556Z" color={color} />
      <Path d="M39.2627 38.4819H42.7892V42.0084H39.2627V38.4819Z" color={color} />
      <Path d="M28.2373 38.4819H31.7638V42.0084H28.2373V38.4819Z" color={color} />
      <Path d="M17.2109 38.4814H20.7374V42.0079H17.2109V38.4814Z" color={color} />
    </svg>
  );
}
